...
echo " <script type='javascript/text'>alert('NO...');</script> ";	 
}
?>
...
<td>&nbsp;&nbsp;&nbsp;<a href="order_page_prescription_byPharma.php?med_id=<?php echo $row['med_id']?>  & Customer_id=<?php echo $Customer_id ?> " name="add_to_cart" type="submit"  style="display: -webkit-inline-box;min-width:120px;border-radius:10px;width:120px;color:white;background:#1b9bff; padding:10px;padding-left:29px;text-align:center;" >Add to cart&nbsp; <i style="font-size:20px;" class="fa fa-shopping-cart"></i></a></td>			
