...
$query1=" select * from customer_order where Action='pending'  ";
...
<a href="logout_ph.php"><label style="background:#30a4ffd1;margin-left:14%;" class ="bk" ><i class="fa fa-sign-out"></i>&nbsp;Logout&nbsp;</label></a>
...
//if(isset($_POST['count_ord'])){
 ...
 $conn=mysqli_connect("localhost","root","","drug");
		 $result=mysqli_query($conn,"SELECT * FROM customer_order where Prescription='yes'  ")or die(mysqli_error());
	...
	<!--td>&nbsp;&nbsp;&nbsp;<a href="update_ph.php?pharmacist_id=<?php// echo $row['pharmacist_id']?>"  style="color:white;background:green;position:relative;padding:10px;padding-left:29px;text-align:center;" >EDIT</a></td-->
	 ...
	 { 
	 ?>
<td>&nbsp;&nbsp;&nbsp;<a href="pharmacist_order_view.php?invoice_no=<?php echo $row['invoice_no']?>  & Action='pending' " name="Taken" type="submit"  style="display: -webkit-inline-box;min-width:120px;border-radius:10px;width:120px;color:white;background:#1125ff; padding:10px;padding-left:29px;text-align:center;" >Ordered&nbsp; </a></td>	
	 <?php
	 }else{ 
	 ?>
<td>&nbsp;&nbsp;&nbsp;<a href="pharmacist_order_view.php?invoice_no=<?php echo $row['invoice_no']?>  & Action='pending' " name="Taken" type="submit"  style="display: -webkit-inline-box;min-width:120px;border-radius:10px;width:120px;color:white;background:#1b9bff; padding:10px;padding-left:29px;text-align:center;" >Finished&nbsp; </a></td>
		 <?php 
		 }
		 ?>
...
//if(isset($_POST['count_ord'])){
 ...
 $conn=mysqli_connect("localhost","root","","drug");
		 ...
		 $result=mysqli_query($conn,"SELECT * FROM customer_order where Action='pending'   ")or die(mysqli_error());
...
if(isset($_POST['search'])){
	...
	?><div style="overflow-x:scroll;"><?php
	$conn=mysqli_connect("localhost","root","","drug");
		 $result=mysqli_query($conn," SELECT * FROM customer_order where Drug_name='$Drug_name' OR Comapany_name='$Drug_name' OR invoice_no='$Drug_name' ")or die(mysqli_error());		 
